...
vocab_path = data_folder + '/data/D_cbow_pdw.pkl' # Path to the python dictionary containing the vocabulary.
wordemb_path = data_folder + '/data/D_cbow_pdw.pkl' # Path to the python dictionary containing the word embeddings.
dataset_path = data_folder + '/data/msa_dataset.hdf5' # path to load the hdf5 dataset containing queries and ground-truth documents.
docs_path = data_folder + '/data/msa_corpus.hdf5' # Path to load the articles and links.
docs_path_term = data_folder + '/data/msa_corpus.hdf5' # Path to load the articles and links.
...
batch_size_train=10  # The batch size during training.
...
max_words_input = 15 # Maximum number of words from the input text.
